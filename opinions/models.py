...
class OpinionQuestion(models.Model):
    ...
    can_see_answers = models.ManyToManyField(Profile, related_name='validators', blank=True)
    can_answer = models.ManyToManyField(Profile, related_name='answerers', blank=True)
